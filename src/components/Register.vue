            ...
            <!--<div class="weui-cell__bd">-->
              <!--<div class="weui-uploader">-->
                <!--<div class="weui-uploader__hd">-->
                  ...
                  <!--&lt;!&ndash; <p class="weui-uploader__title">图片上传</p>-->
                  <!--<div class="weui-uploader__info">0/2</div> &ndash;&gt;-->
                <!--</div>-->
                <!--<div class="weui-uploader__bd">-->
                  <!--<ul class="weui-uploader__files" id="uploaderFiles">-->
                    <!--&lt;!&ndash; <li @click="fadeIn()" class="weui-uploader__file weui-uploader__file_status" style="background-image:url(./images/pic_160.png)">-->
                  ...
                  <!--<div class="weui-uploader__input-box">-->
                    ...
                    <!--&lt;!&ndash;<input id="uploaderInput" @change="upload" class="weui-uploader__input" type="file" accept="image/*" multiple/>&ndash;&gt;-->
                  <!--</div>-->
                <!--</div>-->
              <!--</div>-->
            <!--</div>-->
