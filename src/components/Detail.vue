  ...
  <!--<div id="main">-->
    ...
    <!--<div id="header">-->
      ...
      <!--<div id="userImg">-->
        ...
        <!--&lt;!&ndash;<img v-if="data.studentImg===null" src="../assets/img/user.jpg" width="100%">&ndash;&gt;-->
        <!--&lt;!&ndash;<img v-else :src="path+data.studentImg" width="100%"/>&ndash;&gt;-->
      <!--</div>-->
      ...
      <!--<div id="counter">-->
        <!--<div class="weui-flex">-->
          ...
          <!--<div class="weui-flex__item">-->
            ...
            <!--</div>-->
          <!--</div>-->
          <!--&lt;!&ndash; <div class="weui-flex__item">-->
              <!--<div class="placeholder">-->
                  <!--<div>-->
